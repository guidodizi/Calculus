...
import calculus.backend.controller.v2.admin.ProfesorController;
...
public class AdminProfesorControllerTest {
    @Autowired
...
//    }
    ...
    public void testCreate() throws Exception {
        ...
        try{
            ...
            profe = new Profesor();
            profe.setId(null);
            profe.setEmail("admin@adminTest.com");
            profe.setNombre("AdminTest");
            profe.setPassword("adminTest");
            ...
            Map<Long, Pregunta> pregC2 = profe.getPreguntasCreadas();
            profesorController.create(profe, uriComponentsBuilder, token);
            
            ResponseEntity<List<Profesor>> profesores = profesorController.findAll(token);

            Assert.state(profesores.getBody().contains(profe), "No se encontro el nuevo en el profesor.");
        }
        catch(Exception e){
